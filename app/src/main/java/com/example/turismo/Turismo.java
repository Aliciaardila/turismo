...
public class Turismo implements Serializable {
    ...
    public Turismo(String nombreActividad, String rangodeEdad, String horarioActividad, String descripcion, int fotoActividad1) {
    ...
    public int getFotoActividad1() {
        return fotoActividad1;
    }

    public void setFotoActividad1(int fotoActividad1) {
        this.fotoActividad1 = fotoActividad1;
    }
}
